...
default[:labpages][:sidekiq][:log_file]         = "#{node[:labpages][:log_dir]}/#{node[:labpages][:app_name]}_sidekiq.log"
default[:labpages][:sidekiq][:pid_file]         = "#{node[:labpages][:pid_dir]}/#{node[:labpages][:app_name]}_sidekiq.pid"
